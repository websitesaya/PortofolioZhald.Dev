...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ==========================================
  if (!isCoarsePointer) {
    const tiltCards = document.querySelectorAll('.portfolio-card, .featured-card');
  ...
  // ==========================================
  // 15. POLAROID PHOTO TILT (subtle, matches new design)
  // ==========================================
  const polaroid = document.querySelector('.polaroid');
  if (polaroid && !isCoarsePointer) {
    polaroid.addEventListener('mouseenter', () => {
      polaroid.style.transition = 'transform 0.4s cubic-bezier(0.23,1,0.32,1)';
  ...
  // ==========================================
  // 15X. LEGACY (disabled) — kept out of the flow on purpose
  // ==========================================
  const aboutFrame = null;
  const aboutWrapper = null;
